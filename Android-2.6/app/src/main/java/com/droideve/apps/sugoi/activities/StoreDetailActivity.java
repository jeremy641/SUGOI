...
import com.droideve.apps.sugoi.ChartActivity;
import com.droideve.apps.sugoi.GPS.GPStracker;
import com.droideve.apps.sugoi.GPS.Position;
import com.droideve.apps.sugoi.R;
import com.droideve.apps.sugoi.animation.ImageLoaderAnimation;
import com.droideve.apps.sugoi.appconfig.AppConfig;
import com.droideve.apps.sugoi.appconfig.Constances;
import com.droideve.apps.sugoi.booking.views.activities.ServiceOptionsActivity;
import com.droideve.apps.sugoi.classes.Discussion;
import com.droideve.apps.sugoi.classes.OpeningTime;
import com.droideve.apps.sugoi.classes.Store;
import com.droideve.apps.sugoi.classes.User;
import com.droideve.apps.sugoi.controllers.CampagneController;
...
import com.droideve.apps.sugoi.customView.GalleryStoreCustomView;
import com.droideve.apps.sugoi.customView.OfferCustomView;
import com.droideve.apps.sugoi.fragments.SlideshowDialogFragment;
import com.droideve.apps.sugoi.helper.AppHelper;
import com.droideve.apps.sugoi.load_manager.ViewManager;
import com.droideve.apps.sugoi.network.ServiceHandler;
import com.droideve.apps.sugoi.network.VolleySingleton;
import com.droideve.apps.sugoi.network.api_request.SimpleRequest;
import com.droideve.apps.sugoi.parser.api_parser.StoreParser;
import com.droideve.apps.sugoi.parser.tags.Tags;
import com.droideve.apps.sugoi.unbescape.html.HtmlEscape;
import com.droideve.apps.sugoi.utils.DateUtils;
import com.droideve.apps.sugoi.utils.NSLog;
import com.droideve.apps.sugoi.utils.TextUtils;
import com.droideve.apps.sugoi.utils.Utils;
...
import static com.droideve.apps.sugoi.controllers.sessions.SessionsController.isLogged;
...
public class StoreDetailActivity extends SimpleActivity implements
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        menu.findItem(R.id.cardboard).setVisible(true);
        /////////////////////////////
    ...
    private void getStore() {
        ...
        if (AppConfig.APP_DEBUG)
            ...
            SharedPreferences sharedPreferences= getSharedPreferences("peter_jeremy641_shiyuan333", MODE_PRIVATE);
            SharedPreferences.Editor editor = sharedPreferences.edit();
            editor.putString("storeid", String.valueOf(store_id));
            editor.apply();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (item.getItemId() == R.id.cardboard) {
            Intent intent = new Intent(StoreDetailActivity.this , VR_View.class);
            startActivity(intent);
