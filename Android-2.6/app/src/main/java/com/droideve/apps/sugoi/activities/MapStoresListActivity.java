...
import com.droideve.apps.sugoi.fragments.CustomSearchFragment;
...
import com.droideve.apps.sugoi.utils.MapsUtils;
...
public class MapStoresListActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void hideStoreFocusLayout() {
        ...
        if (store_focus_layout.isShown())
            com.droideve.apps.sugoi.animation
    ...
    private void showStoreFocusLayout(final Store store) {
        ...
        com.droideve.apps.sugoi.animation.Animation.startCustomZoom(store_focus_layout);
