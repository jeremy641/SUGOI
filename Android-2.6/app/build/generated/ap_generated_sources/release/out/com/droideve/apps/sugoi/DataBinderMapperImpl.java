...
import com.droideve.apps.sugoi.databinding.V2FragmentCustomSearchBindingImpl;
import com.droideve.apps.sugoi.databinding.V2FragmentProfileEditBindingImpl;
import com.droideve.apps.sugoi.databinding.V2FragmentProfilePasswordBindingImpl;
import com.droideve.apps.sugoi.databinding.V2FragmentProfileSignupBindingImpl;
import com.droideve.apps.sugoi.databinding.V2StoreGalleryHorizontalBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.droideve.apps.sugoi.R.layout.v2_fragment_custom_search, LAYOUT_V2FRAGMENTCUSTOMSEARCH);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.droideve.apps.sugoi.R.layout.v2_fragment_profile_edit, LAYOUT_V2FRAGMENTPROFILEEDIT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.droideve.apps.sugoi.R.layout.v2_fragment_profile_password, LAYOUT_V2FRAGMENTPROFILEPASSWORD);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.droideve.apps.sugoi.R.layout.v2_fragment_profile_signup, LAYOUT_V2FRAGMENTPROFILESIGNUP);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.droideve.apps.sugoi.R.layout.v2_store_gallery_horizontal, LAYOUT_V2STOREGALLERYHORIZONTAL);
  }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      sKeys.put("layout/v2_fragment_custom_search_0", com.droideve.apps.sugoi.R.layout.v2_fragment_custom_search);
      sKeys.put("layout/v2_fragment_profile_edit_0", com.droideve.apps.sugoi.R.layout.v2_fragment_profile_edit);
      sKeys.put("layout/v2_fragment_profile_password_0", com.droideve.apps.sugoi.R.layout.v2_fragment_profile_password);
      sKeys.put("layout/v2_fragment_profile_signup_0", com.droideve.apps.sugoi.R.layout.v2_fragment_profile_signup);
      sKeys.put("layout/v2_store_gallery_horizontal_0", com.droideve.apps.sugoi.R.layout.v2_store_gallery_horizontal);
    }
  }
}
