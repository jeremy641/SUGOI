...
public class ChartAnalysisActivity_ViewBinding implements Unbinder {
  private ChartAnalysisActivity target;

  @UiThread
  public ChartAnalysisActivity_ViewBinding(ChartAnalysisActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ChartAnalysisActivity_ViewBinding(ChartAnalysisActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ChartAnalysisActivity target = this.target;
