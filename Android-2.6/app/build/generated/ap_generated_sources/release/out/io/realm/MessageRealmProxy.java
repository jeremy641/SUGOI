...
public class MessageRealmProxy extends com.droideve.apps.sugoi.classes.Message
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Message> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Message>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.droideve.apps.sugoi.classes.Message obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Message.class);
            MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Message.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Message.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("messageid")) {
                if (json.isNull("messageid")) {
                    obj = (io.realm.MessageRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Message.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.MessageRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Message.class, json.getString("messageid"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Message createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Message obj = new com.droideve.apps.sugoi.classes.Message();
        final MessageRealmProxyInterface objProxy = (MessageRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Message copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Message object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Message) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Message realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Message copy(Realm realm, com.droideve.apps.sugoi.classes.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Message realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Message.class, ((MessageRealmProxyInterface) newObject).realmGet$messageid(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Message object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Message.class);
        long pkColumnIndex = columnInfo.messageidIndex;
        com.droideve.apps.sugoi.classes.Message object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Message) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Message.class);
    ...
    public static com.droideve.apps.sugoi.classes.Message createDetachedCopy(com.droideve.apps.sugoi.classes.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Message unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Message();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Message) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Message) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Message update(Realm realm, com.droideve.apps.sugoi.classes.Message realmObject, com.droideve.apps.sugoi.classes.Message newObject, Map<RealmModel, RealmObjectProxy> cache) {
