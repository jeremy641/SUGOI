...
public class UpComingEventRealmProxy extends com.droideve.apps.sugoi.classes.UpComingEvent
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.UpComingEvent> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.UpComingEvent>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.UpComingEvent createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.droideve.apps.sugoi.classes.UpComingEvent obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.UpComingEvent.class);
            UpComingEventColumnInfo columnInfo = (UpComingEventColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.UpComingEvent.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.UpComingEvent.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("event_id")) {
                if (json.isNull("event_id")) {
                    obj = (io.realm.UpComingEventRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.UpComingEvent.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.UpComingEventRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.UpComingEvent.class, json.getInt("event_id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.UpComingEvent createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.UpComingEvent obj = new com.droideve.apps.sugoi.classes.UpComingEvent();
        final UpComingEventRealmProxyInterface objProxy = (UpComingEventRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.UpComingEvent copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.UpComingEvent object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.UpComingEvent) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.UpComingEvent realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.UpComingEvent copy(Realm realm, com.droideve.apps.sugoi.classes.UpComingEvent newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.UpComingEvent realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.UpComingEvent.class, ((UpComingEventRealmProxyInterface) newObject).realmGet$event_id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.UpComingEvent object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UpComingEventColumnInfo columnInfo = (UpComingEventColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.UpComingEvent.class);
        long pkColumnIndex = columnInfo.event_idIndex;
        com.droideve.apps.sugoi.classes.UpComingEvent object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.UpComingEvent) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.UpComingEvent object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.UpComingEvent.class);
    ...
    public static com.droideve.apps.sugoi.classes.UpComingEvent createDetachedCopy(com.droideve.apps.sugoi.classes.UpComingEvent realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.UpComingEvent unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.UpComingEvent();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.UpComingEvent) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.UpComingEvent) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.UpComingEvent update(Realm realm, com.droideve.apps.sugoi.classes.UpComingEvent realmObject, com.droideve.apps.sugoi.classes.UpComingEvent newObject, Map<RealmModel, RealmObjectProxy> cache) {
