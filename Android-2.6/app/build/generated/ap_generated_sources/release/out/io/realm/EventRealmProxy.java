...
public class EventRealmProxy extends com.droideve.apps.sugoi.classes.Event
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Event> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Event>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Event createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.droideve.apps.sugoi.classes.Event obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Event.class);
            EventColumnInfo columnInfo = (EventColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Event.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Event.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.EventRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Event.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.EventRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Event.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Event createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Event obj = new com.droideve.apps.sugoi.classes.Event();
        final EventRealmProxyInterface objProxy = (EventRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Event copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Event object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Event) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Event realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Event copy(Realm realm, com.droideve.apps.sugoi.classes.Event newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Event realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Event.class, ((EventRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Event object, Map<RealmModel,Long> cache) {
        ...
        com.droideve.apps.sugoi.classes.Images ImagesObj = ((EventRealmProxyInterface) object).realmGet$Images();
        if (ImagesObj != null) {
        ...
        RealmList<com.droideve.apps.sugoi.classes.Images> listImagesList = ((EventRealmProxyInterface) object).realmGet$listImages();
        if (listImagesList != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        EventColumnInfo columnInfo = (EventColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Event.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.Event object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Event) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Event object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Event.class);
    ...
    public static com.droideve.apps.sugoi.classes.Event createDetachedCopy(com.droideve.apps.sugoi.classes.Event realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Event unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Event();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Event) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Event) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Event update(Realm realm, com.droideve.apps.sugoi.classes.Event realmObject, com.droideve.apps.sugoi.classes.Event newObject, Map<RealmModel, RealmObjectProxy> cache) {
