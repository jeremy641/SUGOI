...
public class SavedStoresRealmProxy extends com.droideve.apps.sugoi.classes.SavedStores
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.SavedStores> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.SavedStores>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.SavedStores createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.droideve.apps.sugoi.classes.SavedStores obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.SavedStores.class);
            SavedStoresColumnInfo columnInfo = (SavedStoresColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.SavedStores.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.SavedStores.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.SavedStoresRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.SavedStores.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.SavedStoresRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.SavedStores.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.SavedStores createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.SavedStores obj = new com.droideve.apps.sugoi.classes.SavedStores();
        final SavedStoresRealmProxyInterface objProxy = (SavedStoresRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.SavedStores copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.SavedStores object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.SavedStores) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.SavedStores realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.SavedStores copy(Realm realm, com.droideve.apps.sugoi.classes.SavedStores newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.SavedStores realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.SavedStores.class, ((SavedStoresRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.SavedStores object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        SavedStoresColumnInfo columnInfo = (SavedStoresColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.SavedStores.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.SavedStores object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.SavedStores) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.SavedStores object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.SavedStores.class);
    ...
    public static com.droideve.apps.sugoi.classes.SavedStores createDetachedCopy(com.droideve.apps.sugoi.classes.SavedStores realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.SavedStores unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.SavedStores();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.SavedStores) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.SavedStores) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.SavedStores update(Realm realm, com.droideve.apps.sugoi.classes.SavedStores realmObject, com.droideve.apps.sugoi.classes.SavedStores newObject, Map<RealmModel, RealmObjectProxy> cache) {
