...
public class DiscussionRealmProxy extends com.droideve.apps.sugoi.classes.Discussion
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Discussion> proxyState;
    private RealmList<com.droideve.apps.sugoi.classes.Message> messagesRealmList;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Discussion>(this);
    ...
    public com.droideve.apps.sugoi.classes.User realmGet$senderUser() {
        ...
        return proxyState.getRealm$realm().get(com.droideve.apps.sugoi.classes.User.class, proxyState.getRow$realm().getLink(columnInfo.senderUserIndex), false, Collections.<String>emptyList());
    }
    ...
    public RealmList<com.droideve.apps.sugoi.classes.Message> realmGet$messages() {
        ...
        if (messagesRealmList != null) {
            ...
            messagesRealmList = new RealmList<com.droideve.apps.sugoi.classes.Message>(com.droideve.apps.sugoi.classes.Message.class, osList, proxyState.getRealm$realm());
            return messagesRealmList;
        }
    }
    ...
    public void realmSet$messages(RealmList<com.droideve.apps.sugoi.classes.Message> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.droideve.apps.sugoi.classes.Message> original = value;
                value = new RealmList<com.droideve.apps.sugoi.classes.Message>();
                for (com.droideve.apps.sugoi.classes.Message item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.droideve.apps.sugoi.classes.Message linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Discussion createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.droideve.apps.sugoi.classes.Discussion obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Discussion.class);
            DiscussionColumnInfo columnInfo = (DiscussionColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Discussion.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Discussion.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("discussionId")) {
                if (json.isNull("discussionId")) {
                    obj = (io.realm.DiscussionRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Discussion.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.DiscussionRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Discussion.class, json.getInt("discussionId"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("senderUser")) {
            if (json.isNull("senderUser")) {
                ...
                com.droideve.apps.sugoi.classes.User senderUserObj = UserRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("senderUser"), update);
        ...
        if (json.has("messages")) {
            if (json.isNull("messages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.droideve.apps.sugoi.classes.Message item = MessageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.droideve.apps.sugoi.classes.Discussion createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Discussion obj = new com.droideve.apps.sugoi.classes.Discussion();
        final DiscussionRealmProxyInterface objProxy = (DiscussionRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.droideve.apps.sugoi.classes.User senderUserObj = UserRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$senderUser(senderUserObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$messages(new RealmList<com.droideve.apps.sugoi.classes.Message>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.droideve.apps.sugoi.classes.Message item = MessageRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$messages().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.droideve.apps.sugoi.classes.Discussion copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Discussion object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Discussion) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Discussion realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Discussion copy(Realm realm, com.droideve.apps.sugoi.classes.Discussion newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Discussion realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Discussion.class, ((DiscussionRealmProxyInterface) newObject).realmGet$discussionId(), false, Collections.<String>emptyList());
        ...
        com.droideve.apps.sugoi.classes.User senderUserObj = realmObjectSource.realmGet$senderUser();
        if (senderUserObj == null) {
            realmObjectCopy.realmSet$senderUser(null);
        } else {
            com.droideve.apps.sugoi.classes.User cachesenderUser = (com.droideve.apps.sugoi.classes.User) cache.get(senderUserObj);
        ...
        RealmList<com.droideve.apps.sugoi.classes.Message> messagesList = realmObjectSource.realmGet$messages();
        if (messagesList != null) {
            RealmList<com.droideve.apps.sugoi.classes.Message> messagesRealmList = realmObjectCopy.realmGet$messages();
            messagesRealmList.clear();
            for (int i = 0; i < messagesList.size(); i++) {
                com.droideve.apps.sugoi.classes.Message messagesItem = messagesList.get(i);
                com.droideve.apps.sugoi.classes.Message cachemessages = (com.droideve.apps.sugoi.classes.Message) cache.get(messagesItem);
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Discussion object, Map<RealmModel,Long> cache) {
        ...
        com.droideve.apps.sugoi.classes.User senderUserObj = ((DiscussionRealmProxyInterface) object).realmGet$senderUser();
        if (senderUserObj != null) {
        ...
        RealmList<com.droideve.apps.sugoi.classes.Message> messagesList = ((DiscussionRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
            OsList messagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.messagesIndex);
            for (com.droideve.apps.sugoi.classes.Message messagesItem : messagesList) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        DiscussionColumnInfo columnInfo = (DiscussionColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Discussion.class);
        long pkColumnIndex = columnInfo.discussionIdIndex;
        com.droideve.apps.sugoi.classes.Discussion object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Discussion) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Discussion object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Discussion.class);
    ...
    public static com.droideve.apps.sugoi.classes.Discussion createDetachedCopy(com.droideve.apps.sugoi.classes.Discussion realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Discussion unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Discussion();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Discussion) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Discussion) cachedObject.object;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.droideve.apps.sugoi.classes.Message> managedmessagesList = realmSource.realmGet$messages();
            RealmList<com.droideve.apps.sugoi.classes.Message> unmanagedmessagesList = new RealmList<com.droideve.apps.sugoi.classes.Message>();
            unmanagedCopy.realmSet$messages(unmanagedmessagesList);
            int nextDepth = currentDepth + 1;
            int size = managedmessagesList.size();
            for (int i = 0; i < size; i++) {
                com.droideve.apps.sugoi.classes.Message item = MessageRealmProxy.createDetachedCopy(managedmessagesList.get(i), nextDepth, maxDepth, cache);
    ...
    static com.droideve.apps.sugoi.classes.Discussion update(Realm realm, com.droideve.apps.sugoi.classes.Discussion realmObject, com.droideve.apps.sugoi.classes.Discussion newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        RealmList<com.droideve.apps.sugoi.classes.Message> messagesList = realmObjectSource.realmGet$messages();
        RealmList<com.droideve.apps.sugoi.classes.Message> messagesRealmList = realmObjectTarget.realmGet$messages();
