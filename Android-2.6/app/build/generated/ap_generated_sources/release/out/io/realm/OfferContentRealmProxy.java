...
public class OfferContentRealmProxy extends com.droideve.apps.sugoi.classes.OfferContent
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.OfferContent> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.OfferContent>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.OfferContent createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.droideve.apps.sugoi.classes.OfferContent obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.OfferContent.class);
            OfferContentColumnInfo columnInfo = (OfferContentColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.OfferContent.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.OfferContent.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.OfferContentRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.OfferContent.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.OfferContentRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.OfferContent.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.OfferContent createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.OfferContent obj = new com.droideve.apps.sugoi.classes.OfferContent();
        final OfferContentRealmProxyInterface objProxy = (OfferContentRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.OfferContent copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.OfferContent object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.OfferContent) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.OfferContent realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.OfferContent copy(Realm realm, com.droideve.apps.sugoi.classes.OfferContent newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.OfferContent realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.OfferContent.class, ((OfferContentRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.OfferContent object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        OfferContentColumnInfo columnInfo = (OfferContentColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.OfferContent.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.OfferContent object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.OfferContent) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.OfferContent object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.OfferContent.class);
    ...
    public static com.droideve.apps.sugoi.classes.OfferContent createDetachedCopy(com.droideve.apps.sugoi.classes.OfferContent realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.OfferContent unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.OfferContent();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.OfferContent) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.OfferContent) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.OfferContent update(Realm realm, com.droideve.apps.sugoi.classes.OfferContent realmObject, com.droideve.apps.sugoi.classes.OfferContent newObject, Map<RealmModel, RealmObjectProxy> cache) {
