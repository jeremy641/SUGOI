...
public class OfferRealmProxy extends com.droideve.apps.sugoi.classes.Offer
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Offer> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Offer>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Offer createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.droideve.apps.sugoi.classes.Offer obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Offer.class);
            OfferColumnInfo columnInfo = (OfferColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Offer.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Offer.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.OfferRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Offer.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.OfferRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Offer.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Offer createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Offer obj = new com.droideve.apps.sugoi.classes.Offer();
        final OfferRealmProxyInterface objProxy = (OfferRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Offer copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Offer object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Offer) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Offer realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Offer copy(Realm realm, com.droideve.apps.sugoi.classes.Offer newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Offer realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Offer.class, ((OfferRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Offer object, Map<RealmModel,Long> cache) {
        ...
        com.droideve.apps.sugoi.classes.Currency currencyObj = ((OfferRealmProxyInterface) object).realmGet$currency();
        if (currencyObj != null) {
        ...
        com.droideve.apps.sugoi.classes.Images imagesObj = ((OfferRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        OfferColumnInfo columnInfo = (OfferColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Offer.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.Offer object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Offer) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Offer object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Offer.class);
    ...
    public static com.droideve.apps.sugoi.classes.Offer createDetachedCopy(com.droideve.apps.sugoi.classes.Offer realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Offer unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Offer();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Offer) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Offer) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Offer update(Realm realm, com.droideve.apps.sugoi.classes.Offer realmObject, com.droideve.apps.sugoi.classes.Offer newObject, Map<RealmModel, RealmObjectProxy> cache) {
