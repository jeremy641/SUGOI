...
public class BookmarkRealmProxy extends com.droideve.apps.sugoi.classes.Bookmark
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Bookmark> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Bookmark>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Bookmark createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.droideve.apps.sugoi.classes.Bookmark obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Bookmark.class);
            BookmarkColumnInfo columnInfo = (BookmarkColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Bookmark.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Bookmark.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.BookmarkRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Bookmark.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.BookmarkRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Bookmark.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Bookmark createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Bookmark obj = new com.droideve.apps.sugoi.classes.Bookmark();
        final BookmarkRealmProxyInterface objProxy = (BookmarkRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Bookmark copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Bookmark object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Bookmark) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Bookmark realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Bookmark copy(Realm realm, com.droideve.apps.sugoi.classes.Bookmark newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Bookmark realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Bookmark.class, ((BookmarkRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Bookmark object, Map<RealmModel,Long> cache) {
        ...
        com.droideve.apps.sugoi.classes.Images imagesObj = ((BookmarkRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        BookmarkColumnInfo columnInfo = (BookmarkColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Bookmark.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.Bookmark object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Bookmark) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Bookmark object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Bookmark.class);
    ...
    public static com.droideve.apps.sugoi.classes.Bookmark createDetachedCopy(com.droideve.apps.sugoi.classes.Bookmark realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Bookmark unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Bookmark();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Bookmark) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Bookmark) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Bookmark update(Realm realm, com.droideve.apps.sugoi.classes.Bookmark realmObject, com.droideve.apps.sugoi.classes.Bookmark newObject, Map<RealmModel, RealmObjectProxy> cache) {
