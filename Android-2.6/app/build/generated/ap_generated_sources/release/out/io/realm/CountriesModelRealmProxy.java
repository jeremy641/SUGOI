...
public class CountriesModelRealmProxy extends com.droideve.apps.sugoi.classes.CountriesModel
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.CountriesModel> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.CountriesModel>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.CountriesModel createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.droideve.apps.sugoi.classes.CountriesModel obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.CountriesModel.class);
            CountriesModelColumnInfo columnInfo = (CountriesModelColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.CountriesModel.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.CountriesModel.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("name")) {
                if (json.isNull("name")) {
                    obj = (io.realm.CountriesModelRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.CountriesModel.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.CountriesModelRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.CountriesModel.class, json.getString("name"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.CountriesModel createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.CountriesModel obj = new com.droideve.apps.sugoi.classes.CountriesModel();
        final CountriesModelRealmProxyInterface objProxy = (CountriesModelRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.CountriesModel copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.CountriesModel object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.CountriesModel) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.CountriesModel realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.CountriesModel copy(Realm realm, com.droideve.apps.sugoi.classes.CountriesModel newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.CountriesModel realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.CountriesModel.class, ((CountriesModelRealmProxyInterface) newObject).realmGet$name(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.CountriesModel object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        CountriesModelColumnInfo columnInfo = (CountriesModelColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.CountriesModel.class);
        long pkColumnIndex = columnInfo.nameIndex;
        com.droideve.apps.sugoi.classes.CountriesModel object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.CountriesModel) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.CountriesModel object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.CountriesModel.class);
    ...
    public static com.droideve.apps.sugoi.classes.CountriesModel createDetachedCopy(com.droideve.apps.sugoi.classes.CountriesModel realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.CountriesModel unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.CountriesModel();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.CountriesModel) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.CountriesModel) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.CountriesModel update(Realm realm, com.droideve.apps.sugoi.classes.CountriesModel realmObject, com.droideve.apps.sugoi.classes.CountriesModel newObject, Map<RealmModel, RealmObjectProxy> cache) {
