...
public class NotificationRealmProxy extends com.droideve.apps.sugoi.classes.Notification
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Notification> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Notification>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Notification createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.droideve.apps.sugoi.classes.Notification obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Notification.class);
            NotificationColumnInfo columnInfo = (NotificationColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Notification.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Notification.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.NotificationRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Notification.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.NotificationRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Notification.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Notification createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Notification obj = new com.droideve.apps.sugoi.classes.Notification();
        final NotificationRealmProxyInterface objProxy = (NotificationRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Notification copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Notification object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Notification) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Notification realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Notification copy(Realm realm, com.droideve.apps.sugoi.classes.Notification newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Notification realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Notification.class, ((NotificationRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Notification object, Map<RealmModel,Long> cache) {
        ...
        com.droideve.apps.sugoi.classes.Images imagesObj = ((NotificationRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        NotificationColumnInfo columnInfo = (NotificationColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Notification.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.Notification object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Notification) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Notification object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Notification.class);
    ...
    public static com.droideve.apps.sugoi.classes.Notification createDetachedCopy(com.droideve.apps.sugoi.classes.Notification realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Notification unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Notification();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Notification) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Notification) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Notification update(Realm realm, com.droideve.apps.sugoi.classes.Notification realmObject, com.droideve.apps.sugoi.classes.Notification newObject, Map<RealmModel, RealmObjectProxy> cache) {
