...
public class CategoryRealmProxy extends com.droideve.apps.sugoi.classes.Category
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Category> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Category>(this);
    ...
    @Override
    public com.droideve.apps.sugoi.classes.Images realmGet$logo() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.logoIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.droideve.apps.sugoi.classes.Images.class, proxyState.getRow$realm().getLink(columnInfo.logoIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$logo(com.droideve.apps.sugoi.classes.Images value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Category createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.droideve.apps.sugoi.classes.Category obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Category.class);
            CategoryColumnInfo columnInfo = (CategoryColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Category.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Category.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("numCat")) {
                if (json.isNull("numCat")) {
                    obj = (io.realm.CategoryRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Category.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.CategoryRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Category.class, json.getInt("numCat"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("logo")) {
            if (json.isNull("logo")) {
                ...
                com.droideve.apps.sugoi.classes.Images logoObj = ImagesRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("logo"), update);
    ...
    public static com.droideve.apps.sugoi.classes.Category createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Category obj = new com.droideve.apps.sugoi.classes.Category();
        final CategoryRealmProxyInterface objProxy = (CategoryRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.droideve.apps.sugoi.classes.Images logoObj = ImagesRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$logo(logoObj);
                }
    ...
    public static com.droideve.apps.sugoi.classes.Category copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Category object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Category) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Category realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Category copy(Realm realm, com.droideve.apps.sugoi.classes.Category newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Category realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Category.class, ((CategoryRealmProxyInterface) newObject).realmGet$numCat(), false, Collections.<String>emptyList());
        ...
        com.droideve.apps.sugoi.classes.Images logoObj = realmObjectSource.realmGet$logo();
        if (logoObj == null) {
            realmObjectCopy.realmSet$logo(null);
        } else {
            com.droideve.apps.sugoi.classes.Images cachelogo = (com.droideve.apps.sugoi.classes.Images) cache.get(logoObj);
            if (cachelogo != null) {
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Category object, Map<RealmModel,Long> cache) {
        ...
        com.droideve.apps.sugoi.classes.Images logoObj = ((CategoryRealmProxyInterface) object).realmGet$logo();
        if (logoObj != null) {
        ...
        com.droideve.apps.sugoi.classes.Images imagesObj = ((CategoryRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        CategoryColumnInfo columnInfo = (CategoryColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Category.class);
        long pkColumnIndex = columnInfo.numCatIndex;
        com.droideve.apps.sugoi.classes.Category object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Category) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Category object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Category.class);
    ...
    public static com.droideve.apps.sugoi.classes.Category createDetachedCopy(com.droideve.apps.sugoi.classes.Category realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Category unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Category();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Category) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Category) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Category update(Realm realm, com.droideve.apps.sugoi.classes.Category realmObject, com.droideve.apps.sugoi.classes.Category newObject, Map<RealmModel, RealmObjectProxy> cache) {
