...
public class ReviewRealmProxy extends com.droideve.apps.sugoi.classes.Review
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Review> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Review>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Review createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.droideve.apps.sugoi.classes.Review obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Review.class);
            ReviewColumnInfo columnInfo = (ReviewColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Review.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Review.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id_rate")) {
                if (json.isNull("id_rate")) {
                    obj = (io.realm.ReviewRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Review.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.ReviewRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Review.class, json.getInt("id_rate"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Review createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Review obj = new com.droideve.apps.sugoi.classes.Review();
        final ReviewRealmProxyInterface objProxy = (ReviewRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Review copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Review object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Review) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Review realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Review copy(Realm realm, com.droideve.apps.sugoi.classes.Review newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Review realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Review.class, ((ReviewRealmProxyInterface) newObject).realmGet$id_rate(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Review object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        ReviewColumnInfo columnInfo = (ReviewColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Review.class);
        long pkColumnIndex = columnInfo.id_rateIndex;
        com.droideve.apps.sugoi.classes.Review object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Review) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Review object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Review.class);
    ...
    public static com.droideve.apps.sugoi.classes.Review createDetachedCopy(com.droideve.apps.sugoi.classes.Review realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Review unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Review();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Review) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Review) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Review update(Realm realm, com.droideve.apps.sugoi.classes.Review realmObject, com.droideve.apps.sugoi.classes.Review newObject, Map<RealmModel, RealmObjectProxy> cache) {
