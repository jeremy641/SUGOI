...
public class SessionRealmProxy extends com.droideve.apps.sugoi.classes.Session
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Session> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Session>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Session createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.droideve.apps.sugoi.classes.Session obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Session.class);
            SessionColumnInfo columnInfo = (SessionColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Session.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Session.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("sessionId")) {
                if (json.isNull("sessionId")) {
                    obj = (io.realm.SessionRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Session.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.SessionRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Session.class, json.getInt("sessionId"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Session createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Session obj = new com.droideve.apps.sugoi.classes.Session();
        final SessionRealmProxyInterface objProxy = (SessionRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Session copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Session object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Session) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Session realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Session copy(Realm realm, com.droideve.apps.sugoi.classes.Session newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Session realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Session.class, ((SessionRealmProxyInterface) newObject).realmGet$sessionId(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Session object, Map<RealmModel,Long> cache) {
        ...
        com.droideve.apps.sugoi.classes.User userObj = ((SessionRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        SessionColumnInfo columnInfo = (SessionColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Session.class);
        long pkColumnIndex = columnInfo.sessionIdIndex;
        com.droideve.apps.sugoi.classes.Session object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Session) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Session object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Session.class);
    ...
    public static com.droideve.apps.sugoi.classes.Session createDetachedCopy(com.droideve.apps.sugoi.classes.Session realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Session unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Session();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Session) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Session) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Session update(Realm realm, com.droideve.apps.sugoi.classes.Session realmObject, com.droideve.apps.sugoi.classes.Session newObject, Map<RealmModel, RealmObjectProxy> cache) {
