...
public class ImagesRealmProxy extends com.droideve.apps.sugoi.classes.Images
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Images> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Images>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Images createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.droideve.apps.sugoi.classes.Images obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Images.class);
            ImagesColumnInfo columnInfo = (ImagesColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Images.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Images.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.ImagesRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Images.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.ImagesRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Images.class, json.getString("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Images createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Images obj = new com.droideve.apps.sugoi.classes.Images();
        final ImagesRealmProxyInterface objProxy = (ImagesRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Images copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Images object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Images) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Images realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Images copy(Realm realm, com.droideve.apps.sugoi.classes.Images newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Images realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Images.class, ((ImagesRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Images object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        ImagesColumnInfo columnInfo = (ImagesColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Images.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.Images object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Images) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Images object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Images.class);
    ...
    public static com.droideve.apps.sugoi.classes.Images createDetachedCopy(com.droideve.apps.sugoi.classes.Images realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Images unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Images();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Images) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Images) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Images update(Realm realm, com.droideve.apps.sugoi.classes.Images realmObject, com.droideve.apps.sugoi.classes.Images newObject, Map<RealmModel, RealmObjectProxy> cache) {
