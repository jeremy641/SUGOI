...
public class OpeningTimeRealmProxy extends com.droideve.apps.sugoi.classes.OpeningTime
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.OpeningTime> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.OpeningTime>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.OpeningTime createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.droideve.apps.sugoi.classes.OpeningTime obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.OpeningTime.class);
            OpeningTimeColumnInfo columnInfo = (OpeningTimeColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.OpeningTime.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.OpeningTime.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.OpeningTimeRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.OpeningTime.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.OpeningTimeRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.OpeningTime.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.OpeningTime createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.OpeningTime obj = new com.droideve.apps.sugoi.classes.OpeningTime();
        final OpeningTimeRealmProxyInterface objProxy = (OpeningTimeRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.OpeningTime copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.OpeningTime object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.OpeningTime) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.OpeningTime realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.OpeningTime copy(Realm realm, com.droideve.apps.sugoi.classes.OpeningTime newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.OpeningTime realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.OpeningTime.class, ((OpeningTimeRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.OpeningTime object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        OpeningTimeColumnInfo columnInfo = (OpeningTimeColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.OpeningTime.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.OpeningTime object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.OpeningTime) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.OpeningTime object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.OpeningTime.class);
    ...
    public static com.droideve.apps.sugoi.classes.OpeningTime createDetachedCopy(com.droideve.apps.sugoi.classes.OpeningTime realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.OpeningTime unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.OpeningTime();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.OpeningTime) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.OpeningTime) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.OpeningTime update(Realm realm, com.droideve.apps.sugoi.classes.OpeningTime realmObject, com.droideve.apps.sugoi.classes.OpeningTime newObject, Map<RealmModel, RealmObjectProxy> cache) {
