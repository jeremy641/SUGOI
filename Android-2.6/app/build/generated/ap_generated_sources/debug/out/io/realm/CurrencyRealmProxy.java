...
public class CurrencyRealmProxy extends com.droideve.apps.sugoi.classes.Currency
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Currency> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Currency>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Currency createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.droideve.apps.sugoi.classes.Currency obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Currency.class);
            CurrencyColumnInfo columnInfo = (CurrencyColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Currency.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Currency.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.CurrencyRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Currency.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.CurrencyRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Currency.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Currency createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Currency obj = new com.droideve.apps.sugoi.classes.Currency();
        final CurrencyRealmProxyInterface objProxy = (CurrencyRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Currency copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Currency object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Currency) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Currency realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Currency copy(Realm realm, com.droideve.apps.sugoi.classes.Currency newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Currency realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Currency.class, ((CurrencyRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Currency object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        CurrencyColumnInfo columnInfo = (CurrencyColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Currency.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.Currency object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Currency) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Currency object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Currency.class);
    ...
    public static com.droideve.apps.sugoi.classes.Currency createDetachedCopy(com.droideve.apps.sugoi.classes.Currency realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Currency unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Currency();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Currency) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Currency) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Currency update(Realm realm, com.droideve.apps.sugoi.classes.Currency realmObject, com.droideve.apps.sugoi.classes.Currency newObject, Map<RealmModel, RealmObjectProxy> cache) {
