...
public class GuestRealmProxy extends com.droideve.apps.sugoi.classes.Guest
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Guest> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Guest>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Guest createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.droideve.apps.sugoi.classes.Guest obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Guest.class);
            GuestColumnInfo columnInfo = (GuestColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Guest.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Guest.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.GuestRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Guest.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.GuestRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Guest.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Guest createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Guest obj = new com.droideve.apps.sugoi.classes.Guest();
        final GuestRealmProxyInterface objProxy = (GuestRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Guest copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Guest object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Guest) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Guest realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Guest copy(Realm realm, com.droideve.apps.sugoi.classes.Guest newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Guest realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Guest.class, ((GuestRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Guest object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        GuestColumnInfo columnInfo = (GuestColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Guest.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.Guest object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Guest) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Guest object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Guest.class);
    ...
    public static com.droideve.apps.sugoi.classes.Guest createDetachedCopy(com.droideve.apps.sugoi.classes.Guest realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Guest unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Guest();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Guest) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Guest) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Guest update(Realm realm, com.droideve.apps.sugoi.classes.Guest realmObject, com.droideve.apps.sugoi.classes.Guest newObject, Map<RealmModel, RealmObjectProxy> cache) {
