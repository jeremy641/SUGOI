...
public class InboxRealmProxy extends com.droideve.apps.sugoi.classes.Inbox
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Inbox> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Inbox>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Inbox createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.droideve.apps.sugoi.classes.Inbox obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Inbox.class);
            InboxColumnInfo columnInfo = (InboxColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Inbox.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Inbox.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("discussionId")) {
                if (json.isNull("discussionId")) {
                    obj = (io.realm.InboxRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Inbox.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.InboxRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Inbox.class, json.getString("discussionId"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Inbox createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Inbox obj = new com.droideve.apps.sugoi.classes.Inbox();
        final InboxRealmProxyInterface objProxy = (InboxRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Inbox copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Inbox object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Inbox) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Inbox realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Inbox copy(Realm realm, com.droideve.apps.sugoi.classes.Inbox newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Inbox realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Inbox.class, ((InboxRealmProxyInterface) newObject).realmGet$discussionId(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Inbox object, Map<RealmModel,Long> cache) {
        ...
        com.droideve.apps.sugoi.classes.User senderUserObj = ((InboxRealmProxyInterface) object).realmGet$senderUser();
        if (senderUserObj != null) {
        ...
        RealmList<com.droideve.apps.sugoi.classes.Message> messagesList = ((InboxRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        InboxColumnInfo columnInfo = (InboxColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Inbox.class);
        long pkColumnIndex = columnInfo.discussionIdIndex;
        com.droideve.apps.sugoi.classes.Inbox object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Inbox) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Inbox object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Inbox.class);
    ...
    public static com.droideve.apps.sugoi.classes.Inbox createDetachedCopy(com.droideve.apps.sugoi.classes.Inbox realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Inbox unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Inbox();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Inbox) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Inbox) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Inbox update(Realm realm, com.droideve.apps.sugoi.classes.Inbox realmObject, com.droideve.apps.sugoi.classes.Inbox newObject, Map<RealmModel, RealmObjectProxy> cache) {
