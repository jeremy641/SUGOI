...
public class UserRealmProxy extends com.droideve.apps.sugoi.classes.User
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.User> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.User>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.droideve.apps.sugoi.classes.User obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.User.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.User.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.UserRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.User.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.UserRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.User.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.User createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.User obj = new com.droideve.apps.sugoi.classes.User();
        final UserRealmProxyInterface objProxy = (UserRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.User copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.User) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.User realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.User copy(Realm realm, com.droideve.apps.sugoi.classes.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.User realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.User.class, ((UserRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.User object, Map<RealmModel,Long> cache) {
        ...
        com.droideve.apps.sugoi.classes.Images imagesObj = ((UserRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.User.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.User object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.User) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.User.class);
    ...
    public static com.droideve.apps.sugoi.classes.User createDetachedCopy(com.droideve.apps.sugoi.classes.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.User unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.User();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.User) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.User) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.User update(Realm realm, com.droideve.apps.sugoi.classes.User realmObject, com.droideve.apps.sugoi.classes.User newObject, Map<RealmModel, RealmObjectProxy> cache) {
