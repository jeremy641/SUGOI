...
public class BannerRealmProxy extends com.droideve.apps.sugoi.classes.Banner
    ...
    private ProxyState<com.droideve.apps.sugoi.classes.Banner> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.droideve.apps.sugoi.classes.Banner>(this);
    ...
    @SuppressWarnings("cast")
    public static com.droideve.apps.sugoi.classes.Banner createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.droideve.apps.sugoi.classes.Banner obj = null;
        if (update) {
            Table table = realm.getTable(com.droideve.apps.sugoi.classes.Banner.class);
            BannerColumnInfo columnInfo = (BannerColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Banner.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Banner.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.BannerRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Banner.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.BannerRealmProxy) realm.createObjectInternal(com.droideve.apps.sugoi.classes.Banner.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.droideve.apps.sugoi.classes.Banner createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.droideve.apps.sugoi.classes.Banner obj = new com.droideve.apps.sugoi.classes.Banner();
        final BannerRealmProxyInterface objProxy = (BannerRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.droideve.apps.sugoi.classes.Banner copyOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Banner object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.droideve.apps.sugoi.classes.Banner) cachedRealmObject;
        }

        com.droideve.apps.sugoi.classes.Banner realmObject = null;
    ...
    public static com.droideve.apps.sugoi.classes.Banner copy(Realm realm, com.droideve.apps.sugoi.classes.Banner newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.droideve.apps.sugoi.classes.Banner realmObject = realm.createObjectInternal(com.droideve.apps.sugoi.classes.Banner.class, ((BannerRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.droideve.apps.sugoi.classes.Banner object, Map<RealmModel,Long> cache) {
        ...
        com.droideve.apps.sugoi.classes.Images imagesObj = ((BannerRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
        ...
        RealmList<com.droideve.apps.sugoi.classes.Images> listImagesList = ((BannerRealmProxyInterface) object).realmGet$listImages();
        if (listImagesList != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        BannerColumnInfo columnInfo = (BannerColumnInfo) realm.getSchema().getColumnInfo(com.droideve.apps.sugoi.classes.Banner.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.droideve.apps.sugoi.classes.Banner object = null;
        while (objects.hasNext()) {
            object = (com.droideve.apps.sugoi.classes.Banner) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.droideve.apps.sugoi.classes.Banner object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.droideve.apps.sugoi.classes.Banner.class);
    ...
    public static com.droideve.apps.sugoi.classes.Banner createDetachedCopy(com.droideve.apps.sugoi.classes.Banner realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.droideve.apps.sugoi.classes.Banner unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.droideve.apps.sugoi.classes.Banner();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.droideve.apps.sugoi.classes.Banner) cachedObject.object;
            }
            unmanagedObject = (com.droideve.apps.sugoi.classes.Banner) cachedObject.object;
    ...
    static com.droideve.apps.sugoi.classes.Banner update(Realm realm, com.droideve.apps.sugoi.classes.Banner realmObject, com.droideve.apps.sugoi.classes.Banner newObject, Map<RealmModel, RealmObjectProxy> cache) {
